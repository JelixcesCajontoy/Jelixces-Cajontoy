...
import { Code, Database, Server, Brush } from 'lucide-react';
...
const skills: Record<string, string[]> = {
  ...
  'Tools & Platforms': ['Docker', 'Git', 'GitHub', 'Vercel', 'AWS'],
};
  ...
  return (
    <section id="skills" className="w-full py-12 md:py-24 lg:py-32">
      <div className="container px-4 md:px-6">
        ...
        <div className="mx-auto grid max-w-5xl items-start gap-8 mt-12 sm:grid-cols-2 md:gap-12">
          {Object.entries(skills).map(([category, skillList]) => {
            const Icon = icons[category] || Code;
            return (
              <div key={category} className="grid gap-4 p-6 rounded-lg border bg-card text-card-foreground shadow-sm">
